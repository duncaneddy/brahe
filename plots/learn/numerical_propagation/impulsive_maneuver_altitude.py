"""
Impulsive Maneuver Altitude Plot

Generates a plot showing spacecraft altitude over time during a Hohmann transfer,
demonstrating the altitude change from the two impulsive burns.
"""
