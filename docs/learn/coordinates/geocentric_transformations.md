...
For complete API details, see the [Geocentric Coordinates API Reference](../../library_api/python/coordinates/geodetic.md#geocentric-conversions).
...
- [Geocentric Coordinates API Reference](../../library_api/python/coordinates/geodetic.md#geocentric-conversions) - Complete function documentation
