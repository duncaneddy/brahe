...
/// needs, but only `RTN`, `LVLH`, `NTW`, `TNW`, `VNC`, `PQW`, and `EQW` have
/// axes derivations today. A transform through any other kind errors until
/// issue #452 adds the remaining derivations.
///
/// # Examples
///
/// ```rust
