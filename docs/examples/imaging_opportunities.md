...
Combine locations, constraints, and configuration for a realistic imaging scenario:

=== "Python"

    ``` python
    --8<-- "./examples/access/computation/imaging_opportunities.py:8"
    ```

=== "Rust"

    ``` rust
    --8<-- "./examples/access/computation/imaging_opportunities.rs:4"
    ```
