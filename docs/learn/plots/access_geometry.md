...
- **Polar plots** are best for understanding antenna pointing requirements and overhead passes
- **Elevation vs azimuth plots** are best for visualizing terrain obstructions and azimuth-dependent constraints
...
- Use **elevation masks** to model terrain obstructions, antenna constraints, or RF interference zones
- All plot types automatically handle azimuth discontinuities at 0°/360° to avoid visual artifacts
