...
unsafe fn py_rotation_ellipsoid_to_enz<'py>(py: Python<'py>, x_ellipsoid: Bound<'py, PyArray<f64, Ix1>>, as_degrees: bool) -> Bound<'py, PyArray<f64, Ix2>> {
...
unsafe fn py_rotation_enz_to_ellipsoid<'py>(py: Python<'py>, x_ellipsoid: Bound<'py, PyArray<f64, Ix1>>, as_degrees: bool) -> Bound<'py, PyArray<f64, Ix2>> {
...
unsafe fn py_rotation_ellipsoid_to_sez<'py>(py: Python<'py>, x_ellipsoid: Bound<'py, PyArray<f64, Ix1>>, as_degrees: bool) -> Bound<'py, PyArray<f64, Ix2>> {
...
unsafe fn py_rotation_sez_to_ellipsoid<'py>(py: Python<'py>, x_ellipsoid: Bound<'py, PyArray<f64, Ix1>>, as_degrees: bool) -> Bound<'py, PyArray<f64, Ix2>> {
...
unsafe fn py_position_enz_to_azel<'py>(py: Python<'py>, x_enz: Bound<'py, PyArray<f64, Ix1>>, as_degrees: bool) -> Bound<'py, PyArray<f64, Ix1>> {
...
unsafe fn py_position_sez_to_azel<'py>(py: Python<'py>, x_sez: Bound<'py, PyArray<f64, Ix1>>, as_degrees: bool) -> Bound<'py, PyArray<f64, Ix1>> {
