/*!
 * XML reader and writer for the Conjunction Data Message (CDM).
 *
 * Reference: CCSDS 508.0-B-1 (Conjunction Data Message), section 3
 */

use crate::ccsds::common::{CCSDSTimeSystem, format_ccsds_datetime_in};
use crate::ccsds::error::ccsds_parse_error;
use crate::ccsds::xml::common::{escape_xml_attribute, escape_xml_text, validate_xml_characters};
...
mod tests {
    ...
    use crate::ccsds::xml::parse_cdm_xml;
