...
# Create initial epoch and state - orbit with inclination near threshold
...
print(f"\nInclination threshold crossings: {len(inc_events)}")
print(f"SMA threshold crossings: {len(sma_events)}")
