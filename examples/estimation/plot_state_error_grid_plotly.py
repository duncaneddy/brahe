...
# ///
"""
Plot a grid of EKF state errors versus truth trajectory using plotly.

Demonstrates the plot_estimator_state_error_grid function with a 3-sigma
covariance band overlay, showing filter convergence from a perturbed initial
state using ECEF GNSS-style position measurements.
"""
...
# Truth propagator — also used to build the truth trajectory for error comparison
...
# Truth trajectory for error computation (propagated over the full window)
...
# Plot 6-panel state error grid with 3-sigma covariance bands
...
fig.write_html("state_error_grid.html")
...
print("Saved state_error_grid.html")
