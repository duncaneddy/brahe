 ...
 * GP query responses use [`crate::spacetrack::GPRecord`] for interoperability
 * with SpaceTrack GP data.
 *
 * All fields are `Option<String>` since the API may omit fields or return nulls.
 */
...
///
/// Handles the difference between APIs that return values as strings vs numbers.
mod string_or_any {
