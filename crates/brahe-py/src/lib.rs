...
pub fn _brahe(py: Python<'_>, module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    module.add_class::<PyOrbitRelativeFrameKind>()?;
    module.add_class::<PyOrbitRelativeFrameVariant>()?;
    ...
    module.add_function(wrap_pyfunction!(py_jacobian_sez_to_ecef, module)?)?;
    module.add_function(wrap_pyfunction!(py_jacobian_ecef_to_sez, module)?)?;
    module.add_function(wrap_pyfunction!(py_covariance_sez_to_ecef, module)?)?;
    module.add_function(wrap_pyfunction!(py_covariance_ecef_to_sez, module)?)?;
    ...
    module.add_function(wrap_pyfunction!(py_rotation_ecef_to_enz, module)?)?;
    module.add_function(wrap_pyfunction!(py_rotation_enz_to_ecef, module)?)?;
    module.add_function(wrap_pyfunction!(py_omega_enz, module)?)?;
    module.add_function(wrap_pyfunction!(py_jacobian_enz_to_ecef, module)?)?;
    module.add_function(wrap_pyfunction!(py_jacobian_ecef_to_enz, module)?)?;
    module.add_function(wrap_pyfunction!(py_covariance_enz_to_ecef, module)?)?;
    module.add_function(wrap_pyfunction!(py_covariance_ecef_to_enz, module)?)?;
    module.add_function(wrap_pyfunction!(py_state_ecef_to_enz, module)?)?;
    module.add_function(wrap_pyfunction!(py_state_enz_to_ecef, module)?)?;
    ...
    module.add_function(wrap_pyfunction!(py_spk_acceleration, module)?)?;
    module.add_function(wrap_pyfunction!(py_spk_acceleration_from_kernel, module)?)?;
    ...
    module.add_function(wrap_pyfunction!(py_accel_earth_zonal_gravity, module)?)?;
    ...
    module.add_function(wrap_pyfunction!(py_network_mode, module)?)?;
    module.add_function(wrap_pyfunction!(
