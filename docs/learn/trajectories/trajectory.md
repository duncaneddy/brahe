...
=== "Python"
    ...
    ``` python
    --8<-- "./examples/trajectories/trajectory/trajectory_empty.py:8"
    ```
...
=== "Python"
    ...
    ``` python
    --8<-- "./examples/trajectories/trajectory/trajectory_from_data.py:8"
    ```
...
=== "Python"
    ...
    ``` python
    --8<-- "./examples/trajectories/trajectory/trajectory_add.py:8"
    ```
...
=== "Python"
    ...
    ``` python
    --8<-- "./examples/trajectories/trajectory/trajectory_access_index.py:8"
    ```
...
=== "Python"
    ...
    ``` python
    --8<-- "./examples/trajectories/trajectory/trajectory_access_epoch.py:8"
    ```
...
=== "Python"
    ...
    ``` python
    --8<-- "./examples/trajectories/trajectory/trajectory_timespan.py:8"
    ```
...
=== "Python"
    ...
    ``` python
    --8<-- "./examples/trajectories/trajectory/trajectory_interpolate.py:8"
    ```
...
=== "Python"
    ...
    ``` python
    --8<-- "./examples/trajectories/trajectory/trajectory_evict_size.py:8"
    ```
...
=== "Python"
    ...
    ``` python
    --8<-- "./examples/trajectories/trajectory/trajectory_evict_age.py:8"
    ```
...
=== "Python"
    ...
    ``` python
    --8<-- "./examples/trajectories/trajectory/trajectory_iterate.py:8"
    ```
...
=== "Python"
    ...
    ``` python
    --8<-- "./examples/trajectories/trajectory/trajectory_matrix.py:8"
    ```
