...
``` python
--8<-- "./examples/examples/imaging_opportunities.py:18:27"
```

We download all active satellites from CelesTrak and filter for ICEYE spacecraft:

``` python
--8<-- "./examples/examples/imaging_opportunities.py:39:41"
```
...
``` python
--8<-- "./examples/examples/imaging_opportunities.py:65:86"
```
...
``` python
--8<-- "./examples/examples/imaging_opportunities.py:96:100"
```
...
``` python
--8<-- "./examples/examples/imaging_opportunities.py:116:122"
```
...
``` python
--8<-- "./examples/examples/imaging_opportunities.py:128:138"
```
...
--8<-- "./examples/examples/imaging_opportunities.py:18:198"
```
