//! Profile: RK4 numerical propagation, 5×5 spherical-harmonic gravity, no
//! other perturbations. Useful for isolating the cost of low-degree spherical
//! harmonic evaluation.
...
fn main() {
    ...
    eprintln!("rk4_5x5_gravity: {iters} iterations in ~{duration_s:.1}s");
}
