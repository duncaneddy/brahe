...
The [`ForceModelConfig`](../../../library_api/python/propagators/force_model_config.md) is a data structure that specifies which physical perturbations to include in the dynamics and their parameters. Supported force include:
...
The [`NumericalPropagationConfig`](../../../library_api/python/propagators/numerical_propagation_config.md) specifies the integration method, integrator configuration, and variational equations settings:
...
All propagators maintain an internal [`OrbitTrajectory`](../../../library_api/python/trajectories/orbit_trajectory.md) storing propagated states, covariances, state transition matricies, and sensitivities.
