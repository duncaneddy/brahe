...
// Purpose:
//
//   Exercise the reference implementation of Moon position and third-body
...
int main() {
    ...
    int       n;
    double    M;
    Vector    r_Moon(3), a(3), x(6);

    // Header

    cout << "Validate Third-Body Moon Acceleration" << endl << endl;
    ...
    for (n=0;n<16;n+=1) {
        ...
        // Evaluate Moon Position
        r_Moon = Moon(MJD_TT);

        // Compute third-body acceleration
        a = AccelPointMass (Vector(x(0), x(1), x(2)), r_Moon,  GM_Moon );
